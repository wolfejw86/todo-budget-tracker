...
export const UserContext = React.createContext({ user: null, family: null, familyMembers: [], getEmail: () => { }, createFamily: () => { } });
...
export const UserProvider = ({ children }) => {
  ...
  return <UserContext.Provider value={{ user, getEmail, family, familyMembers, createFamily }}>{children}</UserContext.Provider>
}